...
// Getting the video
let vid=navigator.mediaDevices.getUserMedia({video:true,audio:true}).then((stream)=>{
...
// Example usage: Call takeScreenshot() when a button with id "captureButton" is clicked
